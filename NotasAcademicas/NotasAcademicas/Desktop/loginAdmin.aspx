...
<head>
    ...
    <title>Admon Gastos de Viaje</title>
                        ...
                        <div class="container-fluid  colorFondo">
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6">
                                    <img class="img-responsive center-block " src="../imagenes/Banner.png" />
                                </div>
                                <div class="col-lg-6 col-md-6">
                                    <label class="colorBlanco tamanoLabelForm" for="txtUsuario">Administrador</label>
                                </div>
                                <div class="col-lg-6 col-md-6">
                                    <br />
                                    <form role="form">
